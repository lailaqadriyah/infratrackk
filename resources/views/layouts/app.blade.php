                ...
                <ul x-show="openMenus.includes('visualisasi')" x-transition class="mt-1 ml-4 space-y-1">
                    ...
                    <li>
                        <a href="{{ route('dashboard') }}"
                            class="flex items-center gap-3 px-4 py-3 rounded-xl text-sm transition-colors border-l-4 {{ request()->routeIs('dashboard') ? 'bg-blue-100 text-blue-700 font-semibold border-blue-500' : 'border-transparent text-gray-500 hover:bg-gray-100 hover:text-gray-700' }}">
                            <div class="w-1.5 h-1.5 rounded-full bg-current"></div>
