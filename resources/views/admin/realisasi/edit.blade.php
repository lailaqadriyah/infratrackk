...
<div class="bg-white rounded-lg shadow-md p-8 max-w-2xl">
    <form action="{{ route('admin.realisasi.update', $realisasi->id) }}" method="POST" class="space-y-6">
        ...
        <div>
            ...
            <input type="text" name="alokasi" id="alokasi" value="{{ old('alokasi', $realisasi->alokasi) }}" class="w-full border border-gray-300 rounded-lg px-4 py-2 @error('alokasi') border-red-500 @enderror" required>
            @error('alokasi')
                <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
            @enderror
        </div>
        ...
        <div>
            ...
            <input type="text" name="nama_daerah" id="nama_daerah" value="{{ old('nama_daerah', $realisasi->nama_daerah) }}" class="w-full border border-gray-300 rounded-lg px-4 py-2 @error('nama_daerah') border-red-500 @enderror" required>
            @error('nama_daerah')
                <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
            @enderror
        </div>
