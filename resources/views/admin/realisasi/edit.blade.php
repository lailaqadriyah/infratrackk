...
@section('content')
<div class="mb-8">
    <h1 class="text-3xl font-bold text-gray-900">Edit Data Realisasi</h1>
    <p class="text-gray-600 mt-2">Ubah data realisasi yang ada</p>
</div>

<div class="bg-white rounded-lg shadow-md p-8 max-w-2xl">
    <form action="{{ route('admin.realisasi.update', $realisasi->id) }}" method="POST" class="space-y-6">
        @csrf
        @method('PUT')
        ...
        <div>
            ...
            <input type="text" name="program" id="program" value="{{ old('program', $realisasi->program) }}" class="w-full border border-gray-300 rounded-lg px-4 py-2 @error('program') border-red-500 @enderror" required>
            @error('program')
                <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
            @enderror
        </div>
        ...
        <div>
            ...
            <input type="text" name="kegiatan" id="kegiatan" value="{{ old('kegiatan', $realisasi->kegiatan) }}" class="w-full border border-gray-300 rounded-lg px-4 py-2 @error('kegiatan') border-red-500 @enderror" required>
            @error('kegiatan')
                <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
            @enderror
        </div>
        ...
        <div>
            ...
            <input type="text" name="sub_kegiatan" id="sub_kegiatan" value="{{ old('sub_kegiatan', $realisasi->sub_kegiatan) }}" class="w-full border border-gray-300 rounded-lg px-4 py-2 @error('sub_kegiatan') border-red-500 @enderror" required>
            @error('sub_kegiatan')
                <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
            @enderror
        </div>
        ...
        <div>
            ...
            <input type="text" name="indikator" id="indikator" value="{{ old('indikator', $realisasi->indikator) }}" class="w-full border border-gray-300 rounded-lg px-4 py-2 @error('indikator') border-red-500 @enderror" required>
            @error('indikator')
                <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
            @enderror
        </div>
        ...
        <div>
            ...
            <input type="text" name="target" id="target" value="{{ old('target', $realisasi->target) }}" class="w-full border border-gray-300 rounded-lg px-4 py-2 @error('target') border-red-500 @enderror" required>
            @error('target')
                <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
            @enderror
        </div>
        ...
        <div>
            ...
            <input type="number" name="anggaran" id="anggaran" step="0.01" value="{{ old('anggaran', $realisasi->anggaran) }}" class="w-full border border-gray-300 rounded-lg px-4 py-2 @error('anggaran') border-red-500 @enderror" required>
            @error('anggaran')
                <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
            @enderror
        </div>
