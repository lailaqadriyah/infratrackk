...
@section('title', 'Tambah RKPD')

@section('content')
<div class="mb-8">
    <h1 class="text-3xl font-bold text-gray-900">Tambah Data RKPD</h1>
    <p class="text-gray-600 mt-2">Tambahkan data RKPD baru ke sistem</p>
</div>

<div class="bg-white rounded-lg shadow-md p-8 max-w-2xl">
    <form action="{{ route('admin.rkpd.store') }}" method="POST" class="space-y-6">
        @csrf
        ...
        <div class="flex gap-4 pt-6">
            <button type="submit" class="bg-green-600 text-white px-6 py-2 rounded-lg hover:bg-green-700 transition-colors">Simpan</button>
